...
public class IterableHelper
{
    ...
    private static final class EmptyList<T> implements Iterable2<T>
    {
        ...
        public final Iterable2<T> filter(final Func<T,Boolean> f) { return this; }
        public final <U>Iterable2<U> map(final Func<T,U> f) { return new EmptyList<U>(); }
        public final <U>Iterable2<U> choose(final Func<T,Option<U>> f) { return new EmptyList<U>(); }
        public final boolean exists(final Func<T,Boolean> f) { return false; }
        public final boolean forAll(final Func<T,Boolean> f) { return false; }
        public final <U>U fold(final Func2<U,T,U> f, final U seed) { return seed; }
        ...
        public final <U>Iterable2<U> collect(final Func<T,Iterable<U>> f){return new EmptyList<U>();}
        public <U>U in(final Func<Iterable2<T>, U> f){ return f.apply(this); }
