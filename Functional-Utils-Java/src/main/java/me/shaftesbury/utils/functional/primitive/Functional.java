...
public final class Functional
{
     ...
     */
    public final static int findLast(final Func_int_T<Boolean> f, final IntList input)
    {
        if (f == null) throw new IllegalArgumentException("f");
        if (input == null) throw new IllegalArgumentException("input");
     ...
     */
    public final static IntList init(final Func_int_int f,final int howMany)
    {
        if (f == null) throw new IllegalArgumentException("f");
     ...
     */
    public final static <B> List<B> map(final Func_int_T<? extends B> f, final IntIterable input)
    {
     ...
     * @return a list of type B containing the transformed values.
     */
    public final static <B> IntList map(final Func_T_int<? super B> f, final Iterable<B> input)
    {
     ...
     * @return a list of type B containing the transformed values.
     */
    public final static <B> List<B> mapi(final Func2_int_int_T<? extends B> f, final IntIterable input)
    {
        final List<B> output = input instanceof IntList ? new ArrayList<B>(((IntList) input).size()) : new ArrayList<B>();
        int pos = 0;
        final IntIterator iterator = input.iterator();
     ...
     */
    public final static Func_int_T<String> dStringify()
    {
...
//    }
     ...
     */
    public final static IntList filter(final Func_int_T<Boolean> pred, final IntIterable input)
    {
...
//    }
    ...
    public final static IntList init(final int constant,final int howMany)
    {
        if(howMany<1) throw new IllegalArgumentException("howMany");
