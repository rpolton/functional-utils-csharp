...
public final class Option<T>
{
    ...
    public final <U>Option<U> bind(final Function<T,Option<U>> f)
    {
        if(isSome()) return f.apply(Some());
        else return Option.None();
    }

    public final static <A,B,C>Option<C>lift(final BiFunction<A,B,C> f, final Option<A> o1, final Option<B> o2)
    {
