...
public final class LispList
{
    ...
    private static final <T>List<T> filter(final Function<T,Boolean> f, final List<T> input, final List<T> accumulator)
    {
    ...
    public static final <T>List<T> filter(final Function<T,Boolean> f, final List<T> input)
    {
        return reverse(filter(f, input, (List<T>) nil()));
    }

    public static final <T,R>List<R> map(final Function<T,R> f, final List<T> input)
    {
        return input.isEmpty()
               ? (List<R>)nil()
